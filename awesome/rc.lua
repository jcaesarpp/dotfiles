...
widget_launcher = awful.widget.launcher({ image = beautiful.awesome_icon,
                                     menu = main_menu })
...
--widget_kbd_layout = awful.widget.keyboardlayout()
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "f", "e", "w", "n", "c", "d", "r" }, s, awful.layout.layouts[1])
